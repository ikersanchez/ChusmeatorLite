            ...
            <div style={{
                ...
                <div style={{ marginBottom: '20px' }}>
                    ...
                    <ul style={{ color: '#6b7280', fontSize: '0.95rem', paddingLeft: '20px', lineHeight: '1.5' }}>
                        ...
                        <li style={{ marginBottom: '5px' }}><strong>Vote the Vibe:</strong> Tap any marker to vote on its true color. The most voted color represents the community's consensus!</li>
                    </ul>
                </div>
